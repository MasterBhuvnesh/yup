...
export const BLOGS = [
  {
    ...
    "excerpt": "Before diving into ML algorithms, build a strong base in math and programming. This guide outlines essential prerequisites for machine learning success.",
    "content": "Understanding machine learning starts with the right foundation. You\u2019ll need solid knowledge of linear algebra, calculus, probability, statistics, and Python programming.",
    "author": "Dr. Elena Korsakov",
    "date": "2025-07-01",
    "imageUrl": "https://i.pinimg.com/736x/b9/ee/35/b9ee35d34dd9a10a885c8a8f65a4399d.jpg",
    "tags": [
      "Machine Learning",
      "Mathematics",
      "Python"
  ...
  },
  {
    ...
    "excerpt": "A complete guide to using Pandas, Python's powerful data manipulation and analysis library. Learn essential tools, functions, and workflows for handling, cleaning, transforming, analyzing, and visualizing data efficiently.",
    "content": "Pandas is a foundational library for data analysis and manipulation in Python. Built on top of NumPy, it provides intuitive and powerful data structures like Series and DataFrame. It’s essential for data preprocessing, cleaning, exploration, and reporting in data science and machine learning workflows.",
    "author": "Ritika Sen",
    "date": "2025-07-15",
    "imageUrl": "https://i.pinimg.com/736x/b9/ee/35/b9ee35d34dd9a10a885c8a8f65a4399d.jpg",
    "tags": [
    ...
    "sections": [
      ...
      },
      {
        ...
        "content": [
          ...
          "- Export results to Excel or databases with one line of code."
        ]
      }
    ]
  }
